...
features:
  ...
  - icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2v4"/><path d="m4.93 10.93 1.41 1.41"/><path d="M20 18H2"/><path d="M22 22H2"/><path d="m19.07 10.93-1.41 1.41"/><path d="M15.54 8.46a5 5 0 1 0-7.08 0"/></svg>'
    ...
    details: Reflections and lessons learned from years in energy operations in the Gulf region.
    link: /qatar/reflections
    linkText: Explore archives

  - icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 21c.6.5 1.2 1 2.5 1 2.5 0 2.5-2 5-2 1.3 0 1.9.5 2.5 1 .6.5 1.2 1 2.5 1 2.5 0 2.5-2 5-2 1.3 0 1.9.5 2.5 1"/><path d="M19.38 20A11.6 11.6 0 0 0 21 14l-9-4-1 9"/><path d="M4 14l7-11 1 11z"/></svg>'
    title: Return to Vietnam
    details: Journaling the transition back home, travel notes, and settling into retirement life.
    link: /vietnam/journey
  ...
  - icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polygon points="16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88 16.24 7.76"/></svg>'
    ...
    details: Personal knowledge management, coding exploration, reading lists, and creative interests.
    link: /projects/
    linkText: View pursuits
---
